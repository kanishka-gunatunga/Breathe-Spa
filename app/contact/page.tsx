...
const Contact = () => {
    ...
    return (
        <div>
            ...
            {/*<section className={`${styles.map_hours_section} py-5 my-5`}>*/}
            ...
            {/*                </p>*/}
            {/*                <h3 className="mt-5 mb-4">OPENING HOURS</h3>*/}
            ...
            {/*                    </li>*/}
            {/*                </ul>*/}
            {/*                <h3 className="mt-5 mb-4 border-bottom border-1 border-secondary py-4">CONTACT US</h3>*/}
